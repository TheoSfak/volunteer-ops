    ...
    <div class="col-md-2 col-sm-4 mb-3">
        <div class="card kpi-card" style="border-top-color:#5a5c69">
            <div class="card-body text-center p-3">
                ...
                <div class="kpi-label">Πόντοι (ανενεργοί)</div>
                <?php endif; ?>
            </div>
        </div>
    </div>
...
<div class="card mb-3">
    ...
    <div class="card-body table-responsive">
        <table class="table table-sm table-striped table-ranking">
            <thead><tr><th>#</th><th>Εθελοντής</th><th>Τμήμα</th><th>Ώρες</th><th>Βάρδιες</th><?php if (getSetting('points_enabled', '1') === '1'): ?><th>Πόντοι</th><?php endif; ?></tr></thead>
            <tbody>
