        ...
        <div class="flex-grow-1">
            ...
            <div style="opacity:.85">
                ...
                <?php if ($volunteer['phone']): ?>
                    <span class="ms-3"><i class="bi bi-telephone me-1"></i><?php if ($volunteer['phone']): ?><a href="tel:<?= h($volunteer['phone']) ?>" class="text-white"><?= h($volunteer['phone']) ?></a><?php else: ?>-<?php endif; ?></span>
                <?php endif; ?>
