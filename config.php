...
define('APP_VERSION', '3.327.3');
define('DB_SCHEMA_VERSION', 166);
...
define('ANDROID_APPS', [
    'yphresies.gr'          => ['slug' => 'yphresies', 'version' => '1.0.15', 'label' => 'Εθελοντές Σε Δράση'],
    'epidrasis.iloveweb.gr' => ['slug' => 'epidrasis', 'version' => '1.1.14', 'label' => 'ΕΠΙΔΡΑΣΙΣ'],
]);
...
define('ANDROID_APK_VERSION', '1.1.14');
