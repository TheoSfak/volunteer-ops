...
define('ANDROID_APPS', [
    'yphresies.gr'          => ['slug' => 'yphresies', 'version' => '1.0.18', 'label' => 'Εθελοντές Σε Δράση'],
    'epidrasis.iloveweb.gr' => ['slug' => 'epidrasis', 'version' => '1.1.17', 'label' => 'ΕΠΙΔΡΑΣΙΣ'],
]);
...
define('ANDROID_APK_VERSION', '1.1.17');
