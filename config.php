...
define('APP_VERSION', '3.301.0');
define('DB_SCHEMA_VERSION', 156);
...
// Host keys verified against the live sites and against each app's own
// capacitor.config.json server.url — epidrasis.iloveweb.gr carries the 's';
// the 's'-less spelling does not resolve at all.
define('ANDROID_APPS', [
    'yphresies.gr'          => ['slug' => 'yphresies', 'version' => '1.0.13', 'label' => 'Εθελοντές Σε Δράση'],
    'epidrasis.iloveweb.gr' => ['slug' => 'epidrasis', 'version' => '1.1.12', 'label' => 'ΕΠΙΔΡΑΣΙΣ'],
]);
