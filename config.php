...
define('APP_VERSION', '3.321.1');
define('DB_SCHEMA_VERSION', 163);
...
define('ANDROID_APPS', [
    'yphresies.gr'          => ['slug' => 'yphresies', 'version' => '1.0.14', 'label' => 'Εθελοντές Σε Δράση'],
    'epidrasis.iloveweb.gr' => ['slug' => 'epidrasis', 'version' => '1.1.13', 'label' => 'ΕΠΙΔΡΑΣΙΣ'],
]);
...
define('ANDROID_APK_VERSION', '1.1.13');
