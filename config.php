...
define('APP_VERSION', '3.332.0');
define('DB_SCHEMA_VERSION', 167);
...
define('ANDROID_APPS', [
    'yphresies.gr'          => ['slug' => 'yphresies', 'version' => '1.0.17', 'label' => 'Εθελοντές Σε Δράση'],
    'epidrasis.iloveweb.gr' => ['slug' => 'epidrasis', 'version' => '1.1.16', 'label' => 'ΕΠΙΔΡΑΣΙΣ'],
]);
...
define('ANDROID_APK_VERSION', '1.1.16');
