...
if (get('export') === 'csv') {
    ...
    fputcsvSafe($out, ['#', 'Επίθετο (GR)', 'Όνομα (GR)', 'Επίθετο (LAT)', 'Όνομα (LAT)', 'Είδος Σεμιναρίου', 'Ημ. Γέννησης', 'Email', 'Τηλέφωνο', 'Επικοινωνία', 'Ημ/νία Επικοινωνίας', 'Πληρωμή', 'Ημ/νία Πληρωμής', 'Ολοκλήρωση', 'Ημ/νία Ολοκλήρωσης', 'Ημ. Εγγραφής', 'Πηγή', 'Σημειώσεις'], ';', '"', '\\');
    foreach ($rows as $i => $r) {
        fputcsvSafe($out, [
            $i + 1,
            $r['last_name_gr'],
