            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    ...
                    <div class="form-check mb-3">
                        ...
                        <div><small class="text-muted">Ένας εθελοντής που στέκεται ακίνητος στέλνει θέση που «χορεύει» 10–40 μ. από στίγμα σε στίγμα. Με την εξομάλυνση, όσο το κινητό δείχνει ότι στέκεται (από την ταχύτητά του και από το αν τα τελευταία στίγματα προχωρούν σταθερά προς μία κατεύθυνση), τα διαδοχικά στίγματα σταθμίζονται μεταξύ τους και η πινέζα, ο «πλησιέστερος», οι αποστάσεις και ο Βοηθός παίρνουν τη σταθερότερη θέση· μόλις κινηθεί, ακόμα και αργά, περνά σχεδόν αυτούσιο το νέο στίγμα, ώστε η πινέζα να μη μένει πίσω. Σε κάθε περίπτωση η θέση δεν απομακρύνεται ποτέ από το στίγμα του κινητού περισσότερο από το μισό της ακρίβειας που δηλώνει. Το ακατέργαστο στίγμα της συσκευής κρατιέται πάντα ξεχωριστά και η <strong>Ποιότητα GPS</strong> συγκρίνει τα δύο με σημείο αναφοράς. Κλείστε το μόνο αν θέλετε να βλέπετε ό,τι ακριβώς στέλνει το κινητό.</small></div>
                    </div>
                    <div class="mb-3">
