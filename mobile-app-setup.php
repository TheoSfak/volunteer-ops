            ...
            <div class="d-flex gap-3">
                ...
                <div>
                    ...
                    <ul class="text-muted small mb-0">
                        <li><strong>Xiaomi / Redmi / POCO (MIUI):</strong> Ρυθμίσεις → Εφαρμογές → Διαχείριση εφαρμογών → <em><?= h(getSetting('app_name', 'VolunteerOps')) ?></em> → ενεργοποιήστε το <strong>«Αυτόματη εκκίνηση» (Autostart)</strong> — χωρίς αυτό, το MIUI μπορεί να σταματήσει την εφαρμογή στο παρασκήνιο ακόμη κι όταν η μπαταρία είναι «Χωρίς περιορισμούς». Επιπλέον, ανοίξτε την προβολή πρόσφατων εφαρμογών (τετράγωνο κουμπί), βρείτε την κάρτα της εφαρμογής και πατήστε το εικονίδιο κλειδαριού για να την «κλειδώσετε» ώστε να μην κλείνει αυτόματα.</li>
                        <li><strong>Samsung:</strong> Ρυθμίσεις → Φροντίδα συσκευής → Μπαταρία → Όρια χρήσης στο παρασκήνιο → βεβαιωθείτε ότι η εφαρμογή <strong>δεν</strong> είναι στη λίστα «Εφαρμογές σε αδράνεια» ή «Ανενεργές εφαρμογές».</li>
                        <li><strong>Huawei / Honor:</strong> Ρυθμίσεις → Μπαταρία → Εκκίνηση εφαρμογών → βρείτε την εφαρμογή και ενεργοποιήστε τη χειροκίνητη διαχείριση, επιτρέποντας «Αυτόματη εκκίνηση», «Δευτερεύουσα εκκίνηση» και «Εκτέλεση στο παρασκήνιο».</li>
                        <li><strong>Oppo / Realme / OnePlus (ColorOS):</strong> Ρυθμίσεις → Μπαταρία → Βελτιστοποίηση μπαταρίας → επιλέξτε «Χωρίς περιορισμούς» για την εφαρμογή, και ξεχωριστά ενεργοποιήστε το «Autostart» στη Διαχείριση εφαρμογών.</li>
                    </ul>
                </div>
            </div>
